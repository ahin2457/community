...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	<div class="container">
		...
		<ul class="navbar-nav">
			<li class="nav-item"><a class="nav-link <%="login".equals(menu) ? "active" : "" %>" href="/web-community/loginform.jsp">로그인</a></li>
			<li class="nav-item"><a class="nav-link <%="employee".equals(menu) ? "active" : "" %>" href="/web-community/loginform.jsp">내정보 보기</a></li>
